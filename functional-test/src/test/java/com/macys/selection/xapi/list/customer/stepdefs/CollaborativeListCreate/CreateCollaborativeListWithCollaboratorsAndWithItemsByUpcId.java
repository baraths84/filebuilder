...
public class CreateCollaborativeListWithCollaboratorsAndWithItemsByUpcId {
	...
	@Then("^the create collaborative list with items by upcId and collaborators status code is \"([^\"]*)\"$")
	...
	public void response_equal_collaborative_list_with_items() {
		json.body("list.listGuid", equalTo("f338675e-c359-4de9-b083-9000100188"));
	}
}
