...
import static com.macys.selection.xapi.list.util.TestUtils.getListsItemsEndpoint;
import static io.restassured.RestAssured.given;
import static org.hamcrest.Matchers.equalTo;

public class PostFeedbackLike {
    private static final Logger LOGGER = LoggerFactory.getLogger(PostFeedbackLike.class);
