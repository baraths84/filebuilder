 ...
 **/
public class GetRequestsWithIncorrectOffset {

    private Response response;
    private ValidatableResponse json;
    private RequestSpecification request;

    @Given("^list owner with userGuid \"([^\"]*)\" with some requests with incorrect offset$")
    public void a_customer_with_requests_for_several_lists_with_incorrect_offset(String userGuid) {
    ...
    public void a_customer_retrieves_list_of_requests_with_incorrect_offset() {
        response = request
    ...
    @Then("^get requests for several lists with incorrect offset status code is \"([^\"]*)\"$")
