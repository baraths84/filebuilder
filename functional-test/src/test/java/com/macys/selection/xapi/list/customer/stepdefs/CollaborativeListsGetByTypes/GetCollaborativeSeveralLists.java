 ...
 **/
public class GetCollaborativeSeveralLists {

    private Response response;
    private ValidatableResponse json;
    private RequestSpecification request;

    @Given("^customer with userGuid \"([^\"]*)\" who is collaborator of several lists$")
    public void a_customer_with_userGuid_with_collaborative_lists(String userGuid) {
    ...
    public void a_customer_retrieves_colalborator_lists() {
        response = request
    ...
    @Then("^get collaborator lists data status code is \"([^\"]*)\"$")
    public void verify_status_code(int statusCode) {
        json = response.then().statusCode(statusCode);
    }

    @And("^response contains corresponding collaborator lists data$")
    public void contains_collaborator_lists_data() {
