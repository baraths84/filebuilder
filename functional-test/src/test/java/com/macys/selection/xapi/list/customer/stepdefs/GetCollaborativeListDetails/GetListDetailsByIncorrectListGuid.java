 ...
 **/
public class GetListDetailsByIncorrectListGuid {

    private Response response;
    private ValidatableResponse json;
    private RequestSpecification request;

    @Given("^owner with incorrect listGuid \"([^\"]*)\" and userGuid \"([^\"]*)\" without items and without collaborators$")
    ...
    @Then("^get collaborative list details by incorrect listGuid status code is \"([^\"]*)\"$")
