...
public class GetAvatarBlankAvatar {
	  private Response response;
	  private ValidatableResponse json;
	  private RequestSpecification request;


	@Given("^a customer get blank avatar image by userGuid \"([^\"]*)\"$")
	...
	@Then("^get blank avatar image by userGuid status code is \"([^\"]*)\"$")
	...
	public void error_response_equal() {
		json.body("profilePicture.avatar", equalTo(""));
	}
}
