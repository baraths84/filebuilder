...
public class ManageListWithListIdofDifferentCustomer {
	  private Response response;
	  private ValidatableResponse json;
	  private RequestSpecification request;

	  @Given("^a customer with listGuid of different customer \"([^\"]*)\" and userId \"([^\"]*)\"$")
	  ...
	  @Then("^the manage list of different customer status code is \"([^\"]*)\"$")
