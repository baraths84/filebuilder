...
public class GetAvatarIncorrectUserGuid {
	  private Response response;
	  private ValidatableResponse json;
	  private RequestSpecification request;

	@Given("^a customer get avatar image by incorrect userGuid \"([^\"]*)\"$")
	...
	@Then("^get avatar image by incorrect userGuid status code is \"([^\"]*)\"$")
