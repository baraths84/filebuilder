...
public class PostFeedbackDislike {
    private static final Logger LOGGER = LoggerFactory.getLogger(PostFeedbackDislike.class);

    private Response response;
    private ValidatableResponse json;
    private RequestSpecification request;

    @Given("^collaborator with userGuid \"([^\"]*)\" post dislike feedback for itemGuid \"([^\"]*)\" in the collaborative listGuid \"([^\"]*)\"$")
    ...
    @Then("^post dislike feedback by collaborator status code is \"([^\"]*)\"$")
