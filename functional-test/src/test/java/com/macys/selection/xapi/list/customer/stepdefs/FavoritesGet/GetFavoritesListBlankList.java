...
public class GetFavoritesListBlankList {
	  private Response response;
	  private ValidatableResponse json;
	  private RequestSpecification request;

	  @Given("^customer with blank favorites list with userGuid \"([^\"]*)\"$")
	  ...
	  @Then("^status code of getting blank list is \"([^\"]*)\"$")
      ...
      public void response_equal_data(){
	      json.body("list.listGuid", equalTo("a78a1ed1-d7c0-4aae-80001000-2"));
	      json.body("list.products[0]", equalTo(null));
      }
}
