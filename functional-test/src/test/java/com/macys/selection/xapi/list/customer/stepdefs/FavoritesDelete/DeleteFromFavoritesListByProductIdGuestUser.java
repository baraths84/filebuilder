...
public class DeleteFromFavoritesListByProductIdGuestUser {
	  private Response response;
	  private ValidatableResponse json;
	  private RequestSpecification request;

	  @Given("^guest user with listGuid \"([^\"]*)\" with productId \"([^\"]*)\"$")
	  ...
	  @Then("^guest user removes item from favorites by productIdd status code is \"([^\"]*)\"$")
